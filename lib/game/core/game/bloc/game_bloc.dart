...
import 'package:crossworduel/game/core/shedule/limitter_shedule.dart';
import 'package:crossworduel/game/core/shedule/queue_shedule.dart';
...
class GameBloc extends Bloc<GameEvent, GameState> with Normalizer {
  ...
  void _initConnect(RoomEntity parameter, GameMockCreator gameMockCreator) {
    if (_isTesting) {
      final MockParent mock = gameMockCreator(
