...
class _ProfileRemoteDataSourceImpl implements ProfileRemoteDataSourceImpl {
  _ProfileRemoteDataSourceImpl(
    this._dio, {
    this.baseUrl,
  });
  ...
  Future<MeModel> edit(Map<String, dynamic> body) async {
    ...
    final value = MeModel.fromJson(_result.data!);
    return value;
  }
  ...
  Future<ScoreModel> myScore() async {
    ...
    final value = ScoreModel.fromJson(_result.data!);
    return value;
  }
  ...
  Future<HeartTimeModel> getHeartTime() async {
    ...
    final value = HeartTimeModel.fromJson(_result.data!);
    return value;
  }
